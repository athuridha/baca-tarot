  ...
  return (
    <main className="relative flex-1 w-full flex flex-col min-h-[100dvh]">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-20%] right-[-10%] w-[50%] h-[50%] rounded-full bg-emerald-600/5 blur-[120px]" />
        <div className="absolute bottom-[-20%] left-[-10%] w-[40%] h-[40%] rounded-full bg-teal-600/5 blur-[100px]" />
      </div>

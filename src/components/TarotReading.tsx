...
// type DrawnCard is now imported from @/lib/tarot-logic
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-8 md:py-12 min-h-[100dvh] flex flex-col">
      ...
      <motion.div 
        ...
        transition={SPRING}
        className="mb-8 md:mb-12 text-center space-y-4 pt-10"
      >
      ...
      <AnimatePresence mode="wait">
        {step === "select" && (
          <motion.div
            ...
            transition={SPRING}
            className="flex-1 flex flex-col items-center justify-center max-w-3xl mx-auto w-full gap-8"
          >
        ...
        {step === "shuffling" && (
          ...
          >
                ...
                >
                  {i === 0 && (
                    <div className="text-zinc-500 flex flex-col items-center gap-4">
                      <Sparkle weight="duotone" className="w-12 h-12 text-rose-500/50" />
                    </div>
                  )}
                </motion.div>
              ))}
            ...
            <div className="flex items-center gap-3 text-rose-500">
              ...
              <span className="text-xl font-medium tracking-wide">{language === "id" ? "Menghubungkan dengan ether..." : "Consulting the ether..."}</span>
            </div>
          </motion.div>
        )}
